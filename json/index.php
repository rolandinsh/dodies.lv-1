...
$file6 = 'ru.geojson';
$currentlv = <<<EOT
{"type": "FeatureCollection","features": [<cms:content_type 'application/json'/><cms:set count='0' /><cms:pages custom_field='statuss!=slikts' masterpage='obj.php' >{"type": "Feature","properties": {"name": "<cms:show k_page_title />","tips": "<cms:show tips />","st": "<cms:show statuss />","km": "<cms:show garums />","txt": "<cms:excerpt count='200' truncate_chars='1'><cms:show mazais_lv /></cms:excerpt>","dat": "<cms:show datums />","img": "<cms:show my_image_thumb />","img2": "<cms:reverse_related_pages 'photo_product' limit='1' orderby='weight' masterpage='gallery.php' ><cms:show gg_image /></cms:reverse_related_pages>","url": "/lv/obj/<cms:show k_page_name />.html"},"geometry": {"type": "Point","coordinates": [<cms:show lon />,<cms:show lat />]}}<cms:incr count /><cms:if count!=k_total_records>, </cms:if></cms:pages>]}
EOT;
$currentru = <<<EOT
{"type": "FeatureCollection","features": [<cms:content_type 'application/json'/><cms:set count='0' /><cms:pages custom_field='statuss!=slikts' masterpage='obj.php' >{"type": "Feature","properties": {"name": "<cms:show k_page_title />","tips": "<cms:show tips />","st": "<cms:show statuss />","km": "<cms:show garums />","txt": "<cms:excerpt count='200' truncate_chars='1'><cms:show mazais_ru /></cms:excerpt>","dat": "<cms:show datums />","img": "<cms:show my_image_thumb />","img2": "<cms:reverse_related_pages 'photo_product' limit='1' orderby='weight' masterpage='gallery.php' ><cms:show gg_image /></cms:reverse_related_pages>","url": "/lv/obj/<cms:show k_page_name />.html"},"geometry": {"type": "Point","coordinates": [<cms:show lon />,<cms:show lat />]}}<cms:incr count /><cms:if count!=k_total_records>, </cms:if></cms:pages>]}
EOT;
$currenten = <<<EOT
{"type": "FeatureCollection","features": [<cms:content_type 'application/json'/><cms:set count='0' /><cms:pages custom_field='statuss!=slikts' masterpage='obj.php' >{"type": "Feature","properties": {"name": "<cms:show k_page_title />","tips": "<cms:show tips />","st": "<cms:show statuss />","km": "<cms:show garums />","txt": "<cms:excerpt count='200' truncate_chars='1'><cms:show mazais_en /></cms:excerpt>","dat": "<cms:show datums />","img": "<cms:show my_image_thumb />","img2": "<cms:show featured_image/>","url": "/en/obj/<cms:show k_page_name />.html"},"geometry": {"type": "Point","coordinates": [<cms:show lon />,<cms:show lat />]}}<cms:incr count /><cms:if count!=k_total_records>, </cms:if></cms:pages>]}
EOT;
$currenta = <<<EOT
{
...
file_put_contents($file6, $currentru);
</cms:php>
ok
<cms:else/>
not ok
