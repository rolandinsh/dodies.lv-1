<?php
    ...
    define( 'K_DB_NAME', 'couch2' );
    // 5.
    // Database username
    define( 'K_DB_USER', 'couch2' );
    // 6.
    // Database password
    define( 'K_DB_PASSWORD', 'QXc-cr6-BA4-g7v' );
    // 7.
